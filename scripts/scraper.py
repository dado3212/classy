...
def scrapeCurrentClasses(yearCode):
	allSubjects = {
	...
	with requests.Session() as c:
		...
		for match in matches:
			...
			arr = [program, num, fys, title, descrip, xlist, period, room, building, instructor, culture, distrib, lim, "S2017"]
